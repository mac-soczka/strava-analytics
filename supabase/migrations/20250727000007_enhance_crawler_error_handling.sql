-- Enhance the crawler function with comprehensive error handling and reporting
-- This ensures no silent failures and provides detailed error information
...
COMMENT ON FUNCTION trigger_strava_crawler_direct() IS 'Enhanced Strava crawler trigger with comprehensive error handling - processes user data and updates segments every 15 minutes with detailed error reporting'; 