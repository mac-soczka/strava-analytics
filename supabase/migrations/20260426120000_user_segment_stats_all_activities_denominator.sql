-- Align get_user_segment_completion_stats with "all imported activities" as denominator.
-- Previously total_activities excluded rows where segments_fetched IS NULL, which could
-- disagree with the activity count shown elsewhere and confuse percentages.
--
-- DATA SAFETY: Replaces only this function. No table data is modified.
